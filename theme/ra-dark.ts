...
export const raDarkTheme = EditorView.theme({
  '&': {
...
export const raDarkHighlightStyle = HighlightStyle.define([
...
export const raDark: Extension = [
  raDarkTheme,
  syntaxHighlighting(raDarkHighlightStyle),
]
