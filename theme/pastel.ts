...
export const config = {
  ...
  selection: '#2E303EB3',
  cursor: '#DF8598',
  dropdownBackground: '#0b0c0f',
  dropdownBorder: '#BBBBBB',
  activeLine: '#2E303E4D',
  matchingBracket: '#6C6F9380',
  keyword: '#DF8598',
  storage: '#AA93DD',
  variable: '#AFCBFF',
  parameter: '#AFCBFF',
...
export const pastelHighlightStyle = HighlightStyle.define([
...
export const pastel: Extension = [
  pastelTheme,
  syntaxHighlighting(pastelHighlightStyle),
]
