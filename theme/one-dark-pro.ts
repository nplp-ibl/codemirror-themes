...
export const config = {
  ...
  selection: '#67769660',
  cursor: '#528bff',
  dropdownBackground: '#282c34',
  dropdownBorder: '#21252b',
  activeLine: '#2c313c',
...
export const oneDarkProTheme = EditorView.theme({
  '&': {
...
export const oneDarkProHighlightStyle = HighlightStyle.define([
